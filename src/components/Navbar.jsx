	...
	return (
		<>
			<motion.div
				...
				className={`fixed border-b-white/20 border-b-[1px] top-0 left-0 w-full h-[85px] flex text-textDark dark:text-textLight justify-around items-center z-50 backdrop-blur-2xl bg-navbarBackgroundLight/80 dark:bg-navbarBackgroundDark/80`}
			>
				<div
					onClick={() => {
						nav("/");
